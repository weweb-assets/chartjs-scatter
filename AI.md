...
dataType: 'guided'|'advanced' - Data config mode. Default: 'advanced'
labels: string[] - X-axis labels (advanced). Default: ['Tatooine','Coruscant','Kashyyyk','Dagobah']
datasets: object[] - Data arrays (advanced). Default: [{label:'Millenium Falcon',backgroundColor:'rgb(21,101,192)',data:[{y:500,x:1},...]}]
options: object - Chart.js options (advanced). Default: {plugins:{legend:{...}},responsive:true}
data: object[]|null - Data collection (guided). Default: null
